...
# Usa una carpeta de venv específica
...
CMD ["uv", "run", "uvicorn", "app.main:server", "--host", "0.0.0.0", "--reload"] 
...
CMD ["uv", "run", "uvicorn", "app.main:server", "--host", "0.0.0.0", "--forwarded-allow-ips", "*"]
